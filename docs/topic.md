...
_kano/backlog/topics/<topic-name>/
  ...
  brief.md          # Deterministic distilled brief (generated by `kano topic distill`)
...
Generates/overwrites `brief.md` deterministically from the manifest + materials index.
