...
def main() -> int:
    ...
    init_backlog = Path(__file__).resolve().parent / "init_backlog.py"
    ...
    if args.refresh_dashboards == "yes":
        refresh = Path(__file__).resolve().parent / "refresh_dashboards.py"
    ...
    if mode != "none":
        ...
        print("Next steps:")
        print(f"- Create items: python {skill_root_hint}/scripts/backlog/create_item.py --agent <agent-name> --type Task --title \"...\"")
        print(f"- Refresh dashboards: python {skill_root_hint}/scripts/backlog/refresh_dashboards.py --backlog-root {backlog_root.relative_to(repo_root).as_posix()} --agent <agent-name>")
        print("Tip: add the skill block to AGENTS.md/CLAUDE.md via:")
        print(f"- Create missing: python {skill_root_hint}/scripts/backlog/init_project.py --agent <agent-name> --write-guides create")
        print(f"- Append to existing: python {skill_root_hint}/scripts/backlog/init_project.py --agent <agent-name> --write-guides append")
